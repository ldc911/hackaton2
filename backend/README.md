...
- Home page: [GET localhost:8000/](localhost:8000/)
- Item browse: [GET localhost:8000/items](localhost:8000/items)
- Item read: [GET localhost:8000/items/:id](localhost:8000/items/2)
- Item edit: PUT localhost:8000/items/:id
- Item add: POST localhost:8000/items
- Item deletion: DELETE localhost:8000/items/:id

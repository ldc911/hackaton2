...
export default function Order({ carPrice, dataCar, duration, close }) {
  ...
  let TVA = carPrice + 224 + parseInt(assurance.price.split("€")[1]) * 0.2;

  let TOTAL = carPrice + 224 + 999 + parseInt(assurance.price.split("€")[1]);
  ...
  return (
    <div className="fixed h-screen top-0 left-0 w-screen overflow-auto backdrop-blur-sm">
      <div className="bg-gray-50 relative z-30 mx-5 xl:mx-60 my-5 xl:my-10">
       ...
       {!summariesModal ? <div className=" max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <h2 className="sr-only">Valider ma réservation</h2>
          <form className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16" onSubmit={(e) => handleSubmit(e)}>
            <div>
              <div>
              ...
              <div className="mt-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                ...
                <dl className="border-t border-gray-200 py-6 px-4 space-y-6 sm:px-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <dd className="text-sm font-medium text-gray-900">999€</dd>
                  </div>
                  <div className="flex items-center justify-between">
                    <dt className="text-sm">Assurance</dt>
                    <dd className="text-sm font-medium text-gray-900">{assurance.price.split("€")[1]}€</dd>
                  </div>
                  <div className="flex items-center justify-between">
